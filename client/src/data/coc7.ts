...
export const COC7_OCCUPATIONS: COCOccupationDef[] = [
  ...
  { id: 'criminal_thug', name: '打手/暴徒', nameEn: 'Thug', category: 'criminal', creditRange: [5, 30], era: 'any', skillTemplate: ['Drive Auto', 'Fighting', 'Firearms', 'interpersonal', 'interpersonal', 'Psychology', 'Stealth', 'Spot Hidden'] },
